...
ideal.Proto.recordForStore = function(aStore) { // should only be called by Store
...
ideal.Proto.instanceFromRecordInStore = function(aRecord, aStore) { // should only be called by Store    
